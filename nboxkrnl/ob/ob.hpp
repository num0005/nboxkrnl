...
EXPORTNUM(240) extern OBJECT_TYPE ObDirectoryObjectType;
...
EXPORTNUM(245) extern OBJECT_HANDLE_TABLE ObpObjectHandleTable;

EXPORTNUM(246) NTSTATUS XBOXAPI ObReferenceObjectByHandle
(
	HANDLE Handle,
	POBJECT_TYPE ObjectType,
